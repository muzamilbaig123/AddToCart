interface AllProductsTypeDefine {
    id: string,
    prodImg: string,
    prodName: string,
    prodDesc: string,
...
let laptops: AllProductsTypeDefine[] = [
    // laptops
    {
...
let cart: AllProductsTypeDefine[] = [];
...
function AddToCartFeatureCom (index: number) {
    console.log(index)
...
function AddToCartFeatureAcc (index: number) {
    console.log(index)
